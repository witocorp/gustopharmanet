...
/* @var $searchModel backend\models\ArchivosSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = $session['nombreCarpeta'];
...
$this->params['breadcrumbs'][] = '/';
$this->params['breadcrumbs'][] = ['label' => $session['nombreCarpeta']];
...
?>
<div id="appPa"class="carpetas-index">
                    ...
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
						...
						<div v-if="showIndex === index" @mouseleave="showIndex = null"  class="icono_op no_show opciones_caja">
							<a v-bind:href="'<?php echo Url::base(true);?>/index.php?r=archivos%2Fupdate&amp;id='+responder.id"><i class="fas fa-pencil-alt"></i> Edit File</a><br/>
							<a v-bind:href="'<?php echo Url::base(true);?>/index.php?r=archivos%2Fdelete&amp;id='+responder.id" title="Delete" aria-label="Delete" data-confirm="Are you sure you want to delete this file?" data-method="post" data-pjax="0"><i class="fas fa-minus-circle"></i> Delete File</a><br/>
							<a v-bind:href="'<?php echo Url::base(true);?>/index.php?r=archivos%2Fdownload&amp;url='+responder.url"><i class="fas fa-cloud-download-alt"></i> Download File</a>
						</div>
							...
							<div class="col-auto">
							  <i v-bind:class="responder.extension+' fa-2x text-gray-300'"></i>
							</div>
                      </div>
                    </div>
                  </div>
