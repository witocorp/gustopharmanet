	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">Add new Trademark</h5>
	...
	<div class="d-flex justify-content-between bd-highlight mb-3">
		<div class="p-2 bd-highlight">
			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
			  <i class="fas fa-plus-circle"></i> Add Trademark
			</button>
		</div>
		<div class="p-2 bd-highlight">
			<!-- Topbar Search -->
                    ...
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
						...
						<div v-if="showIndex === index" @mouseleave="showIndex = null"  class="icono_op no_show opciones_caja">
							<a v-bind:href="'<?php echo Url::base(true);?>/index.php?r=marcas%2Fupdate&amp;id='+responder.id"><i class="fas fa-pencil-alt"></i> Edit Trademark</a><br/>
							<a v-bind:href="'<?php echo Url::base(true);?>/index.php?r=marcas/delete&id='+responder.id" title="Delete" aria-label="Delete" data-confirm="Are you sure you want to delete this trademark?" data-method="post" data-pjax="0"><i class="fas fa-minus-circle"></i> Delete Trademark</a>
						</div>
